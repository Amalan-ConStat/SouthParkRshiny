...
usethis::use_mit_license("Amalan") # You can set another license here
usethis::use_readme_rmd(open = TRUE)
devtools::build_readme()
# Note that `contact` is required since usethis version 2.1.5
# If your {usethis} version is older, you can remove that param
usethis::use_code_of_conduct(contact = "Amalan")
...
golem::use_favicon("man/figures/logo.png") # path = "path/to/ico". Can be an online file.
